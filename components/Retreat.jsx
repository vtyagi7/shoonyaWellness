                        ...
                        <div className='flex sm:flex-row flex-col gap-2  justify-around pt-3 items-center'>
                            <div className='flex md:flex-row flex-col gap-2'>
                                    {/* <select onChange={locationHandler}>
                                        ...
                                        <option value="yoga">Agra</option>
                                        <option value="meditation">Chennai</option>
                                        <option value="detox">De</option>
                            
                                    </select> */}
                                {/* <button  className="text-white sm:text-base  xxs:text-sm font-montserrat  hover:bg-[#758694] bg-[#405D72] rounded-full flex flex-row gap-4 items-center justify-center px-4 py-2 ">
                                    <span className=''> Filter By Date </span>
                                    <FaCaretDown size={20}/> 
                                </button> */}
                                {/* <button  className="text-white sm:text-base  xxs:text-sm font-montserrat hover:bg-[#758694] bg-[#405D72] rounded-full flex flex-row gap-4 items-center justify-center px-4 py-2 ">
